...
1. Follow the steps in the [SETUP](https://github.com/ashtonkbailey/BYOB/SETUP.md) file to get app running locally on your machine. 
...
3. We would love to have you contribute to our project! Read our [CONTRIBUTING](https://github.com/ashtonkbailey/BYOB/CONTRIBUTING.md) file to see how we like our pull requests.  

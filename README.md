...
1. Follow the steps in the [SETUP.md](BYOB/SETUP.md) file to get app running locally on your machine. 
...
3. We would love to have you contribute to our project! Read our [CONTRIBUTING.md](BYOB/SETUP.md) file to see how we like our pull requests.  
